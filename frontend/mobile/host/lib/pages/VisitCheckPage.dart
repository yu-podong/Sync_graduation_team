...
class VisitCheckPage extends StatefulWidget {
  const VisitCheckPage({Key? key}) : super(key: key);

  @override
  State<VisitCheckPage> createState() => _VisitCheckPageState();
}

class _VisitCheckPageState extends State<VisitCheckPage> {
  User user = User(belong: '충북대학교', position: '학부생', duty: '졸업예정자', name: '송승우', phoneNum: '010-2222-3333');
        ...
        body: Container(
            ...
            child: Column(
              children: <Widget>[
                /* 페이지 설명 부분 */
                Text(
                  '${user.name}님에게 요청된 접견 약속들입니다.',
                  style: const TextStyle(fontSize: 18),
                ),
                  const Text(
                  '각 요청 건마다 승인 또는 거절을 눌러 주세요.',
